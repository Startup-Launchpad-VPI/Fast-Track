...
<!-- Generated by build.mjs — do not edit by hand. Run: node build.mjs -->
<style>
  ...
  *{ box-sizing:border-box; }
  ...
  .card .tag{ font:11px var(--mono); color:var(--clay); border:1px solid var(--sand);
    border-radius:var(--r); padding:2px 8px; letter-spacing:.03em; }
  .card .opentag{ font:11px var(--mono); color:var(--orange-d); border:1px dashed var(--orange-d);
    border-radius:var(--r); padding:2px 8px; letter-spacing:.03em; }
